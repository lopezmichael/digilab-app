...
-- =============================================================================
-- ARCHETYPE FAMILIES TABLE
-- Groups related deck archetypes under umbrella families (e.g., Time Strangers)
-- =============================================================================
CREATE TABLE IF NOT EXISTS archetype_families (
...
CREATE INDEX IF NOT EXISTS idx_archetype_families_slug ON archetype_families(slug);
CREATE INDEX IF NOT EXISTS idx_archetype_families_active ON archetype_families(is_active) WHERE is_active = TRUE;
...
CREATE TABLE IF NOT EXISTS deck_archetypes (
    ...
    family_id INTEGER REFERENCES archetype_families(family_id),  -- Optional family grouping
    notes TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_by TEXT                   -- Admin username who last modified
...
CREATE INDEX IF NOT EXISTS idx_archetypes_family ON deck_archetypes(family_id);
